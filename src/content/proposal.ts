...
export const ui: Record<string, L<string>> = {
  ...
  eyebrowProposal: {
    en: "A National Proposal · May 2026",
    ar: "مقترح وطني · مايو 2026",
  },
  heroHeadlineA: {
  ...
  footerTagline: {
    en: "A proposal for the transformation of Saudi football. May 2026",
    ar: "مقترحٌ لتحويل كرة القدم السعودية. مايو 2026",
  },
  footerSubmitted: {
...
export const urgentCases: L<UrgentCase[]> = {
  ar: [
    ...
    {
      title: "بدل التدريب: حين يصبح التعويض عائقًا أمام انتقال اللاعب وتطوره",
      what: "بدل التدريب حق مشروع للنادي الذي ساهم في تكوين اللاعب، لكن المشكلة تبدأ عندما يتحول هذا الحق من وسيلة لحماية الاستثمار في التطوير إلى قيد عملي يمنع اللاعب من الانتقال أو الاستمرار في مسار احترافي مناسب.\n\nتظهر المشكلة غالبًا مع اللاعبين المتدرجين من الفئات السنية، خصوصًا من لم يحصلوا على فرصة واضحة في الفريق الأول، أو لم يُعرض عليهم عقد احترافي مناسب. عند رغبة نادٍ آخر في التعاقد معهم، قد يتراجع بسبب مبلغ بدل التدريب المطلوب، خاصة إذا كان المبلغ أعلى من قدرة النادي أو لا يتناسب مع قيمة اللاعب السوقية ومستوى المنافسة.\n\nالأثر العملي أن اللاعب قد يبقى عالقًا: النادي الأصلي لا يمنحه فرصة حقيقية، والنادي الجديد لا يستطيع تحمّل تكلفة انتقاله. في بعض الحالات يضطر اللاعب إلى البقاء في مسار الهواة أو اللعب في درجات أقل، ليس بسبب ضعف مستواه فقط، بل لأن كلفة انتقاله أصبحت أعلى من المخاطرة الرياضية التي تستطيع الأندية تحملها.\n\nوالأخطر أن المشكلة لا تبدأ عند سن الاحتراف فقط، بل قد تؤثر على قرارات اللاعب والأسرة منذ مرحلة الناشئين. بعض اللاعبين أو أولياء الأمور قد يترددون في دخول أكاديميات الأندية الرسمية مبكرًا خوفًا من تراكم بدل التدريب مستقبلًا، مما يدفع اللاعب للبقاء في أكاديميات تجارية أو فرق أحياء أقل تنظيمًا. بهذه الطريقة يُحرم اللاعب من بيئة تدريب أفضل في أهم سنوات التكوين، ثم يواجه لاحقًا عائقًا ماليًا عند محاولة الانتقال.",
      causes: [
        "ارتفاع بدل التدريب مقارنة بعمر اللاعب أو قيمته السوقية أو مستوى الدوري.",
        "عدم وجود مرونة كافية في تخفيض المبلغ أو تقسيطه أو تحويله إلى حوافز مستقبلية.",
        "مطالبة النادي الأصلي ببدل تدريب رغم عدم منح اللاعب فرصة واضحة للتدرج أو الاحتراف.",
        "خوف الأندية من التعاقد مع لاعبين شباب بسبب التزامات مالية إضافية غير مضمونة العائد.",
        "غياب آلية تربط بين حق النادي في التعويض وبين جودة التطوير الفعلي الذي حصل عليه اللاعب.",
        "تأخر التواصل بين النادي الأصلي، اللاعب، وكيله أو ولي أمره، والنادي الراغب في التعاقد.",
        "تعامل بعض الأندية مع اللاعب كمصدر تعويض مالي، بدل النظر إليه كمشروع تطوير وانتقال.",
      ],
      impact: [
        "بقاء لاعبين موهوبين في الهواة أو الدرجات الأدنى رغم قدرتهم على اللعب في مستويات أعلى.",
        "خسارة اللاعب لسنوات مهمة من التطور الفني والبدني والتكتيكي.",
        "تراجع رغبة الأندية في التعاقد مع لاعبي الفئات السنية بسبب المخاطر المالية.",
        "تردد بعض الأسر واللاعبين في دخول أكاديميات الأندية مبكرًا خوفًا من القيود المستقبلية.",
        "انخفاض دافع اللاعب عندما يشعر أن النادي لا يمنحه فرصة ولا يسمح له بالانتقال.",
        "خسارة الأندية نفسها لفرص مالية معقولة كان يمكن تحقيقها عبر انتقال مرن.",
        "تحوّل بدل التدريب من أداة لحماية النادي المُكوّن إلى عائق يقلل حركة اللاعبين داخل المنظومة.",
      ],
      solutions: [
        "وضع سياسة مرنة لبدل التدريب تراعي عمر اللاعب، مستواه، عدد سنواته في النادي، ومستوى النادي الراغب في التعاقد.",
        "تخفيض المبلغ أو تقسيطه إذا كان ذلك يساعد على انتقال اللاعب بدل تعطيل الصفقة بالكامل.",
        "قبول نسبة بيع مستقبلية أو حوافز مرتبطة بالمشاركة أو الصعود للفريق الأول بدل المطالبة بمبلغ مرتفع مقدمًا.",
        "إنشاء لجنة انتقالات داخل النادي لدراسة كل حالة لاعب بشكل مستقل.",
        "إشراك اللاعب وولي أمره أو وكيله مبكرًا في النقاش قبل أن تصل الحالة إلى طريق مسدود.",
        "اعتماد مبدأ “الفرصة أو التنازل”: إذا لم يمنح النادي اللاعب عقدًا احترافيًا أو مسارًا واضحًا للتطور عند بلوغه سنًا محددة، فيجب تخفيف أو إسقاط المطالبة ببدل التدريب عند انتقاله.",
        "تحويل بدل التدريب من عائق إلى أداة تفاوض تحفظ حق النادي، ولا تمنع اللاعب من التطور.",
      ],
      recommendation:
        "إعادة تنظيم آلية بدل التدريب محليًا بحيث لا يُلغى حق النادي في التعويض، لكنه لا يتحول إلى قيد يعطل مستقبل اللاعب. ويُقترح اعتماد مبدأ “الفرصة أو التنازل”: النادي الذي يطوّر اللاعب ويمنحه مسارًا واضحًا يستحق حماية حقه، أما النادي الذي لا يمنح اللاعب فرصة مناسبة فلا ينبغي أن يبقى بدل التدريب أداة تمنع انتقاله أو تدفعه للبقاء في مسار الهواة.\n\nأساس تنظيمي مختصر\n\nتعترف لوائح FIFA بمبدأ تعويض التدريب للأندية التي ساهمت في تدريب وتطوير اللاعب، ويظهر هذا الحق عند أول تسجيل للاعب كمحترف أو في انتقالات معينة قبل نهاية السنة التي يبلغ فيها اللاعب 23 عامًا، مع ارتباط مرحلة التكوين بعمر 12 إلى 23 عامًا. كما تتضمن لوائح الاتحاد السعودي تنظيمًا لمسائل أوضاع اللاعبين وانتقالاتهم والتعويض عن التدريب. لذلك فالمقترح لا يلغي مبدأ التعويض، بل يهدف إلى ضبطه بطريقة أكثر عدالة ومرونة تخدم اللاعب والنادي والمنظومة.",
    },
  ],
  en: [
    {
